...
namespace WinformUI.CADHelper
{
    ...
    public static partial class Tools
    {
        ...
        public static int GetNumInStr(this string str)
        {
            string numString = System.Text.RegularExpressions.Regex.Replace(str, @"[^0-9]+", "");
            int num = 0;
             int.TryParse(numString, out num);
            return num;
        }
        public static bool GetNumInStrOrNot(this string str)
        {
            string numString = System.Text.RegularExpressions.Regex.Replace(str, @"[^0-9]+", "");
        ...
        public static double GetNumInStrIncDouble(this string str)
        {
            string numString = System.Text.RegularExpressions.Regex.Replace(str, @"[^\d.\d]", "");
            double num = 0;
