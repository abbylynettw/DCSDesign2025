...
namespace WinformUI.CADHelper
{
    ...
    public static class EntTools
    {
        ...
        /// <param name="sourcePt">移动的源点</param>
        /// <param name="targetPt">移动的目标点</param>
        public static void Move(this Entity ent, DrawingUtility util, Point3d sourcePt, Point3d targetPt)
        {
            ...
            else // 如果是已经添加到数据库中的实体
            {
                ...
                ////找到标注，移动标注
                //var labelEnt = util.GetLabel(ent);
                //if (labelEnt != null)
                //{
                //    labelEnt.ObjectId.Move(sourcePt, targetPt);
                //}
            }
        }
        ...
        /// <param name="sourcePt">移动的源点</param>
        /// <param name="targetPt">移动的目标点</param>
        public static void MoveCustom(this Entity ent, DrawingUtility util, Point3d sourcePt, Point3d targetPt)
        {
            if (ent.IsNewObject) // 如果是还未被添加到数据库中的新实体
            {
                // 构建用于移动实体的矩阵
