...
namespace WinformUI.CADHelper
{
    ...
    public static class XrefTools
    {
        ...
        /// <returns></returns>
        public static ObjectId AttachXref(this Database db, string fileName, string blockName,ObjectId layerId, Point3d insertionPoint, Scale3d scaleFactors, double rotation, bool isOverlay)
        {
